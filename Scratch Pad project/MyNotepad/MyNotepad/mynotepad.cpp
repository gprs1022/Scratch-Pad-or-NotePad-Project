...
void MyNotepad::about()
{
   QMessageBox::about(this, tr("About MDI"),
                tr("This GUI Notepad made by Veerbahdur Sen and Pradeep sinhg"));
...
void MyNotepad::on_actionTextBackgroundColor_triggered()
{
    QColor color=QColorDialog::getColor(Qt::white,this,"Choose Color");
    if(color.isValid())
    {
...
void MyNotepad::on_actionBackgroundColor_triggered()
{
    QColor color=QColorDialog::getColor(Qt::white,this,"Choose Color");
    if(color.isValid())
    {
